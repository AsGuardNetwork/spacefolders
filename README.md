...
docker pull asguardNetwork/spacefolders:comdex-v8.1.1
...
docker pull asguardNetwork/spacefolders:evmos-v11.0.1
docker pull asguardNetwork/spacefolders:evmos-11.0.1
```
...
docker pull asguardNetwork/spacefolders:ics-v1.0.0-rc5
docker pull asguardNetwork/spacefolders:ics-1.0.0-rc5
```
...
docker pull asguardNetwork/spacefolders:juno-v11.0.3
...
docker pull asguardNetwork/spacefolders:nibiru-v0.19.0
